    ...
    <div className='w-full py-[10rem] px-4 bg-white'>
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8 '>
            <div className='w-full shadow-xl flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
                ...
                <button className='bg-[#00df9a] w-[200px] rounded-md font-medium my-6 px-6 mx-auto py-3 text-black justify-center'>Send Trial</button>
            </div>
            ...
            <div className='w-full shadow-xl bg-gray-100 flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300'>
                ...
                <button className='bg-black text-[#00df9a] w-[200px] rounded-md font-medium my-6 px-6 mx-auto py-3 justify-center'>Send Trial</button>
            </div>
