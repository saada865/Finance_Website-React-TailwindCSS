        ...
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
            ...
            <div className='flex flex-col justify-center '>
                ...
                <p className=''>Lorem ipsum dolor sit amet consectetur
                 adipisicing elit. Et sunt, totam ab quo reprehenderit,
                  quas quibusdam nostrum dolore facere quae rem tempora
                   praesentium iste nulla libero quaerat voluptatibus
                    quia harum!</p>
